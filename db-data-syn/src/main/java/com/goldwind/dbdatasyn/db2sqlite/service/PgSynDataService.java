...
public class PgSynDataService implements ISynData
{
    ...
    public void createSqliteFileCopy() throws Exception
    {
        try
        {
            FileAssistant.deleteFile(com.goldwind.dbdatasyn.utils.RunParams.getSqlitePath() + "_tmp");
            sqLiteOper = new SQLiteOper(com.goldwind.dbdatasyn.utils.RunParams.getSqlitePath() + "_tmp");
        }
        catch (Exception e)
        {
    ...
    private void excuteInertDataSql(String sql, Table table, HashMap<Integer, Exception> errs) throws Exception
    {
        ...
        String[] sqls = tableToInsSql("\"" + table.getTableName() + "\"", rs, com.goldwind.dbdatasyn.utils.RunParams.getDatabase_url(), com.goldwind.dbdatasyn.utils.RunParams.getUsername(),
    ...
    public void copyToResultFile() throws Exception
    {
        try
        {
            FileAssistant.deleteFile(com.goldwind.dbdatasyn.utils.RunParams.getSqlitePath());
            FileAssistant.copyFile(com.goldwind.dbdatasyn.utils.RunParams.getSqlitePath() + "_tmp", com.goldwind.dbdatasyn.utils.RunParams.getSqlitePath());
            FileAssistant.deleteFile(com.goldwind.dbdatasyn.utils.RunParams.getSqlitePath() + "_tmp");
        }
        catch (Exception e)
        {
