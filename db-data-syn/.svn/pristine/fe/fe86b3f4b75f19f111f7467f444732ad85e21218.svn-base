...
public class InitServiceTest
{
    public static void main(String[] args) throws Exception
    {
        ...
        participation1.setName("change@separator@changedata");
        participation1.setType(Enums.ParticipationType.table);

        Participation participation2 = new Participation();
        participation2.setName("config");
        participation2.setType(Enums.ParticipationType.schema);

        Participation participation3 = new Participation();
        participation3.setName("custom");
        participation3.setType(Enums.ParticipationType.schema);
