...
public class localTest
{
    public static void main(String[] args) throws Exception
    {
        ...
        //postgres oid数据类型的查询
        //        DbOperBase dbOperBase = new DbOperBase(DbAssistant.DatabaseType.Postgre, "jdbc:postgresql://10.80.5.109:8101/qhsoam_dev", "pguser", "pguser");
        //        dbOperBase.openConn();
        //        Connection connection = dbOperBase.getConn();
        //        connection.setAutoCommit(false);
        //        LargeObjectManager lobj = ((org.postgresql.PGConnection) connection).getLargeObjectAPI();
        //        LargeObject obj = lobj.open(864229, LargeObjectManager.READ);
        ...
        //        String path = "D:/a/b/c/xxx.txt";
        //        FileAssistant.mkdirsByFilePath(path, "/");

        String x = "abc'scf'vvfa";
        x = x.replace("\'", "\'\'");
