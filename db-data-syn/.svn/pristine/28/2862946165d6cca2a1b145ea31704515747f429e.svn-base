...
public interface ISynData
{
     ...
     * @return 数据库脚本集合
     */
    void compareTableData(Integer protocolid, TableData sqliteData, TableData dbData, Table table, Map<String, HashMap<Integer, Exception>> errInfos, List<String> delSqls) throws Exception;
