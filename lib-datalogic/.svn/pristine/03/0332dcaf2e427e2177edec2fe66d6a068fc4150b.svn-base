    ...
    public EnergyEfficiencyBean getEnergyEfficiency(int vWtid, String date)
    {
        try
        {
            ...
            {                
                ...
                detailBean.setBeginelec(oneDataBean.getBeginelec());
                detailBean.setEndelec(oneDataBean.getEndelec());
                detailBean.setDensity(oneDataBean.getDensity());
