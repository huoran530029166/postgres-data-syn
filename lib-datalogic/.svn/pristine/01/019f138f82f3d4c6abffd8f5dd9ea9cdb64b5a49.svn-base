...
public class InverterElectricityLossTest
{
    @BeforeClass
    ...
    public void test()
    {
        try (DbOperBase dbOper = new DbOperBase())
        {
            ...
            Date startime = sdf.parse("2019-04-04 00:00:00");
            Date endtime = sdf.parse("2019-04-06 00:00:00");
            List<String> listdev = new ArrayList<String>(Arrays.asList("632523502", "632523504", "632523505", "632523508", "632523506", "632523502", "632523502", "632523506", "632523504"));

            long start1 = System.currentTimeMillis();
            List<Losselec> newList = inter.getDeviceLossElec(startime, endtime, listdev, null, "40", Together.DayTogether);
